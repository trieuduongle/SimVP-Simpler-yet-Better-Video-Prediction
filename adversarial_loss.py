...
class DiscriminatorBlock(nn.Module):
    def __init__(self, filters,strides):
        ...
        self.conv0 = nn.Conv2d(filters,kernel_size=4, stride=strides,padding='same')
...
class Discriminator(nn.Module):
    def __init__(self, device):
        ...
        self.conv0 =  nn.Conv2d(64, kernel_size=4, stride=2, padding='same')
        self.leakyReLU = nn.LeakyReLU(negative_slope=0.2)
        self.block0 = DiscriminatorBlock(128, 2)
        self.block1 = DiscriminatorBlock(256, 2)
        self.block2 = DiscriminatorBlock(512, 1)
        self.conv1 = nn.Conv2d(1, kernel_size=4, stride=1, padding='same')
